def poisson(input_params):
  ...
  return {
      "poisson_x_E1": best_solution[0],
      "poisson_x_E2": best_solution[1],
      "poisson_x_S1": best_solution[2],
      "poisson_x_S2": best_solution[3],
      "poisson_x_B1": best_solution[4],
      "poisson_profit": best_profit
  }
